  ...
  return (
    <Container maxW='container.lg' my={10}>
      <Box>
        ...
        <Image src='/howto_01.gif' alt='howto_01' w={400} />
      </Box>
      <Divider my={10} />
      <Box>
        <Text fontSize='large' my={4} fontWeight='bold'>
        ...
        <Image src='/howto_02.gif' alt='howto_02' w={400} />
      </Box>
      <Divider my={10} />
      <Box>
        <Text fontSize='large' my={4} fontWeight='bold'>
        ...
        <Image src='/howto_03.gif' alt='howto_03' w={400} />
      </Box>
  ...
  return (
    <Container maxW='container.lg' my={10}>
      ...
      <Box w={'100%'}>
        ...
        <Image src='/howto_04.gif' alt='howto_04' w={400} />
      </Box>
